...
ROOT_URLCONF = 'cjws.urls'

WSGI_APPLICATION = 'cjws.wsgi.application'
...
if STORAGE_TYPE == 'normal':
    ...
    AWS_ACCESS_KEY_ID = 'AKIAJGZG6FSEENTN4N2Q'
    AWS_SECRET_ACCESS_KEY ='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'
